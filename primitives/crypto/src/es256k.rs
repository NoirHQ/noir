...
pub const CRYPTO_ID: CryptoTypeId = CryptoTypeId(*b"es2k");
...
fn derive_hard_junction(secret_seed: &Seed, cc: &[u8; 32]) -> Seed {
	("Secp256k1HDKD", secret_seed, cc).using_encoded(blake2_256)
}
...
mod tests {
	...
	fn test_vector_should_work() {
		...
		let message = b"";
		let signature: [u8; 64] = array_bytes::hex2array_unchecked("389250949b3a65cb2c06976348c00ad8afafdc2defe306983e9ba2d9dbe7d16564ad6c61f990a3f56408539ea753659131da4a3224c16c3c8cc5040dc3caa154");
