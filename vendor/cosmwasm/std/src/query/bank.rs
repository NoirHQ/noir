...
use crate::{prelude::*, Binary, DenomMetadata};
...
pub enum BankQuery {
	...
	/// This calls into the native bank module for querying metadata for all bank tokens that have
	/// a metadata entry. Return value is AllDenomMetadataResponse
	#[cfg(feature = "cosmwasm_1_3")]
...
mod tests {
	...
	fn private_constructor_works() {
		...
		assert_eq!(response, AllBalanceResponse { amount: vec![Coin::new(1234u128, "uatom")] });
	}
}
