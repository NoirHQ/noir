...
use crate::{
	...
	Decimal, Decimal256, Int512, SignedDecimal,
	__internal::forward_ref_partial_eq,
};

use super::{Fraction, Int256};
...
impl SignedDecimal256 {
	...
	/// This is equivalent to `SignedDecimal256::from_atomics(value, 18)` but usable in a const
	/// context.
	///
	/// # Examples
	///
	...
	pub fn from_atomics(
		...
		Ok(match decimal_places.cmp(&(Self::DECIMAL_PLACES)) {
			Ordering::Less => {
				...
				Self(atomics.checked_mul(factor).map_err(|_| SignedDecimal256RangeExceeded)?)
			},
	...
	pub fn checked_ceil(&self) -> Result<Self, RoundUpOverflowError> {
		...
		if floor == self {
			...
			floor.checked_add(SignedDecimal256::one()).map_err(|_| RoundUpOverflowError)
		}
	}
	...
	/// Multiplies one `SignedDecimal256` by another, returning an `OverflowError` if an overflow
	/// occurred.
...
impl FromStr for SignedDecimal256 {
	...
	fn from_str(input: &str) -> Result<Self, Self::Err> {
		...
		if let Some(fractional_part) = parts_iter.next() {
			...
			let fractional_part = Int256::from(fractional).checked_mul(fractional_factor).unwrap();
...
mod tests {
	...
	fn signed_decimal_256_percent() {
		...
		assert_eq!(value.0, SignedDecimal256::DECIMAL_FRACTIONAL / Int256::from(2u8));

		let value = SignedDecimal256::percent(-50);
		assert_eq!(value.0, SignedDecimal256::DECIMAL_FRACTIONAL / Int256::from(-2i8));
	}

	#[test]
	fn signed_decimal_256_permille() {
		let value = SignedDecimal256::permille(125);
		assert_eq!(value.0, SignedDecimal256::DECIMAL_FRACTIONAL / Int256::from(8u8));

		let value = SignedDecimal256::permille(-125);
		assert_eq!(value.0, SignedDecimal256::DECIMAL_FRACTIONAL / Int256::from(-8i8));
	}

	#[test]
	fn signed_decimal_256_bps() {
		let value = SignedDecimal256::bps(125);
		assert_eq!(value.0, SignedDecimal256::DECIMAL_FRACTIONAL / Int256::from(80u8));

		let value = SignedDecimal256::bps(-125);
		assert_eq!(value.0, SignedDecimal256::DECIMAL_FRACTIONAL / Int256::from(-80i8));
	}
	...
	fn signed_decimal_256_from_atomics_works() {
		...
		assert_eq!(SignedDecimal256::from_atomics(1000000000000000000i128, 18).unwrap(), one);
		assert_eq!(SignedDecimal256::from_atomics(10000000000000000000i128, 19).unwrap(), one);
		assert_eq!(SignedDecimal256::from_atomics(100000000000000000000i128, 20).unwrap(), one);
		...
		assert_eq!(SignedDecimal256::from_atomics(2000000000000000000i128, 18).unwrap(), two);
		assert_eq!(SignedDecimal256::from_atomics(20000000000000000000i128, 19).unwrap(), two);
		assert_eq!(SignedDecimal256::from_atomics(200000000000000000000i128, 20).unwrap(), two);
	...
	fn signed_decimal_256_from_ratio_works() {
		// 1.0
		assert_eq!(SignedDecimal256::from_ratio(1i128, 1i128), SignedDecimal256::one());
		assert_eq!(SignedDecimal256::from_ratio(53i128, 53i128), SignedDecimal256::one());
		assert_eq!(SignedDecimal256::from_ratio(125i128, 125i128), SignedDecimal256::one());

		// -1.0
		assert_eq!(SignedDecimal256::from_ratio(-1i128, 1i128), SignedDecimal256::negative_one());
		...
		// 1.5
		assert_eq!(SignedDecimal256::from_ratio(3i128, 2i128), SignedDecimal256::percent(150));
		assert_eq!(SignedDecimal256::from_ratio(150i128, 100i128), SignedDecimal256::percent(150));
		assert_eq!(SignedDecimal256::from_ratio(333i128, 222i128), SignedDecimal256::percent(150));

		// 0.125
		assert_eq!(SignedDecimal256::from_ratio(1i64, 8i64), SignedDecimal256::permille(125));
		assert_eq!(SignedDecimal256::from_ratio(125i64, 1000i64), SignedDecimal256::permille(125));
		...
		// large inputs
		assert_eq!(SignedDecimal256::from_ratio(0i128, i128::MAX), SignedDecimal256::zero());
		assert_eq!(SignedDecimal256::from_ratio(i128::MAX, i128::MAX), SignedDecimal256::one());
	...
	fn signed_decimal_256_implements_fraction() {
		...
		assert_eq!(fraction.numerator(), Int256::from(1_234_567_000_000_000_000_000i128));
		assert_eq!(fraction.denominator(), Int256::from(1_000_000_000_000_000_000i128));
	...
	fn signed_decimal_256_from_str_works() {
		// Integers
		assert_eq!(SignedDecimal256::from_str("0").unwrap(), SignedDecimal256::percent(0));
		assert_eq!(SignedDecimal256::from_str("1").unwrap(), SignedDecimal256::percent(100));
		assert_eq!(SignedDecimal256::from_str("5").unwrap(), SignedDecimal256::percent(500));
		assert_eq!(SignedDecimal256::from_str("42").unwrap(), SignedDecimal256::percent(4200));
		assert_eq!(SignedDecimal256::from_str("000").unwrap(), SignedDecimal256::percent(0));
		assert_eq!(SignedDecimal256::from_str("001").unwrap(), SignedDecimal256::percent(100));
		assert_eq!(SignedDecimal256::from_str("005").unwrap(), SignedDecimal256::percent(500));
		assert_eq!(SignedDecimal256::from_str("0042").unwrap(), SignedDecimal256::percent(4200));

		// Positive decimals
		assert_eq!(SignedDecimal256::from_str("1.0").unwrap(), SignedDecimal256::percent(100));
		assert_eq!(SignedDecimal256::from_str("1.5").unwrap(), SignedDecimal256::percent(150));
		assert_eq!(SignedDecimal256::from_str("0.5").unwrap(), SignedDecimal256::percent(50));
		assert_eq!(SignedDecimal256::from_str("0.123").unwrap(), SignedDecimal256::permille(123));

		assert_eq!(SignedDecimal256::from_str("40.00").unwrap(), SignedDecimal256::percent(4000));
		assert_eq!(SignedDecimal256::from_str("04.00").unwrap(), SignedDecimal256::percent(400));
		assert_eq!(SignedDecimal256::from_str("00.40").unwrap(), SignedDecimal256::percent(40));
		assert_eq!(SignedDecimal256::from_str("00.04").unwrap(), SignedDecimal256::percent(4));
		// Negative decimals
		assert_eq!(SignedDecimal256::from_str("-00.04").unwrap(), SignedDecimal256::percent(-4));
		assert_eq!(SignedDecimal256::from_str("-00.40").unwrap(), SignedDecimal256::percent(-40));
		assert_eq!(SignedDecimal256::from_str("-04.00").unwrap(), SignedDecimal256::percent(-400));
		...
		assert_eq!(SignedDecimal256::from_str("-1").unwrap(), SignedDecimal256::negative_one());
	}
	...
	fn signed_decimal_256_from_str_errors_for_broken_fractional_part() {
		...
		assert_eq!(SignedDecimal256::from_str("1.2e3").unwrap_err(), expected_err);
		assert_eq!(SignedDecimal256::from_str("1.-2").unwrap_err(), expected_err);
	}
	...
	fn signed_decimal_256_from_str_errors_for_more_than_18_fractional_digits() {
		...
		assert_eq!(SignedDecimal256::from_str("7.1234567890123456789").unwrap_err(), expected_err);
		// No special rules for trailing zeros. This could be changed but adds gas cost for the
		// happy path.
		assert_eq!(SignedDecimal256::from_str("7.1230000000000000000").unwrap_err(), expected_err);
	}
	...
	fn signed_decimal_256_from_str_errors_for_invalid_number_of_dots() {
		...
		assert_eq!(SignedDecimal256::from_str("1.2.3").unwrap_err(), expected_err);
		assert_eq!(SignedDecimal256::from_str("1.2.3.4").unwrap_err(), expected_err);
	}
	...
	fn signed_decimal_256_conversions_work() {
		assert_eq!(SignedDecimal256::from(SignedDecimal::zero()), SignedDecimal256::zero());
		assert_eq!(SignedDecimal256::from(SignedDecimal::one()), SignedDecimal256::one());
		assert_eq!(
	...
	fn signed_decimal_256_inv_works() {
		...
		// d == -1
		assert_eq!(SignedDecimal256::negative_one().inv(), Some(SignedDecimal256::negative_one()));
	...
	fn signed_decimal_256_add_works() {
		...
		assert_eq!(SignedDecimal256::zero() + SignedDecimal256::zero(), SignedDecimal256::zero());
		// negative numbers
		assert_eq!(
			SignedDecimal256::percent(-5) + SignedDecimal256::percent(-4),
			SignedDecimal256::percent(-9)
	...
	fn signed_decimal_256_implements_mul() {
		...
		// 1*x and x*1
		assert_eq!(one * SignedDecimal256::percent(0), SignedDecimal256::percent(0));
		assert_eq!(one * SignedDecimal256::percent(1), SignedDecimal256::percent(1));
		assert_eq!(one * SignedDecimal256::percent(10), SignedDecimal256::percent(10));
		assert_eq!(one * SignedDecimal256::percent(100), SignedDecimal256::percent(100));
		assert_eq!(one * SignedDecimal256::percent(1000), SignedDecimal256::percent(1000));
		assert_eq!(one * SignedDecimal256::MAX, SignedDecimal256::MAX);
		assert_eq!(SignedDecimal256::percent(0) * one, SignedDecimal256::percent(0));
		assert_eq!(SignedDecimal256::percent(1) * one, SignedDecimal256::percent(1));
		assert_eq!(SignedDecimal256::percent(10) * one, SignedDecimal256::percent(10));
		assert_eq!(SignedDecimal256::percent(100) * one, SignedDecimal256::percent(100));
		assert_eq!(SignedDecimal256::percent(1000) * one, SignedDecimal256::percent(1000));
		assert_eq!(SignedDecimal256::MAX * one, SignedDecimal256::MAX);
		assert_eq!(SignedDecimal256::percent(-1) * one, SignedDecimal256::percent(-1));
		assert_eq!(one * SignedDecimal256::percent(-10), SignedDecimal256::percent(-10));

		// double
		assert_eq!(two * SignedDecimal256::percent(0), SignedDecimal256::percent(0));
		assert_eq!(two * SignedDecimal256::percent(1), SignedDecimal256::percent(2));
		assert_eq!(two * SignedDecimal256::percent(10), SignedDecimal256::percent(20));
		assert_eq!(two * SignedDecimal256::percent(100), SignedDecimal256::percent(200));
		assert_eq!(two * SignedDecimal256::percent(1000), SignedDecimal256::percent(2000));
		assert_eq!(SignedDecimal256::percent(0) * two, SignedDecimal256::percent(0));
		assert_eq!(SignedDecimal256::percent(1) * two, SignedDecimal256::percent(2));
		assert_eq!(SignedDecimal256::percent(10) * two, SignedDecimal256::percent(20));
		assert_eq!(SignedDecimal256::percent(100) * two, SignedDecimal256::percent(200));
		assert_eq!(SignedDecimal256::percent(1000) * two, SignedDecimal256::percent(2000));
		assert_eq!(SignedDecimal256::percent(-1) * two, SignedDecimal256::percent(-2));
		assert_eq!(
		...
		// half
		assert_eq!(half * SignedDecimal256::percent(0), SignedDecimal256::percent(0));
		assert_eq!(half * SignedDecimal256::percent(1), SignedDecimal256::permille(5));
		assert_eq!(half * SignedDecimal256::percent(10), SignedDecimal256::percent(5));
		assert_eq!(half * SignedDecimal256::percent(100), SignedDecimal256::percent(50));
		assert_eq!(half * SignedDecimal256::percent(1000), SignedDecimal256::percent(500));
		assert_eq!(SignedDecimal256::percent(0) * half, SignedDecimal256::percent(0));
		assert_eq!(SignedDecimal256::percent(1) * half, SignedDecimal256::permille(5));
		assert_eq!(SignedDecimal256::percent(10) * half, SignedDecimal256::percent(5));
		assert_eq!(SignedDecimal256::percent(100) * half, SignedDecimal256::percent(50));
		assert_eq!(SignedDecimal256::percent(1000) * half, SignedDecimal256::percent(500));
	...
	fn signed_decimal_256_checked_mul() {
		let test_data = [
			...
			(SignedDecimal256::MAX / Int256::from(2), SignedDecimal256::percent(200)),
			(SignedDecimal256::permille(6), SignedDecimal256::permille(13)),
			(SignedDecimal256::permille(-6), SignedDecimal256::permille(0)),
	...
	fn signed_decimal_256_implements_div() {
		...
		// 1/x and x/1
		assert_eq!(one / SignedDecimal256::percent(1), SignedDecimal256::percent(10_000));
		assert_eq!(one / SignedDecimal256::percent(10), SignedDecimal256::percent(1_000));
		assert_eq!(one / SignedDecimal256::percent(100), SignedDecimal256::percent(100));
		assert_eq!(one / SignedDecimal256::percent(1000), SignedDecimal256::percent(10));
		assert_eq!(SignedDecimal256::percent(0) / one, SignedDecimal256::percent(0));
		assert_eq!(SignedDecimal256::percent(1) / one, SignedDecimal256::percent(1));
		assert_eq!(SignedDecimal256::percent(10) / one, SignedDecimal256::percent(10));
		assert_eq!(SignedDecimal256::percent(100) / one, SignedDecimal256::percent(100));
		...
		// double
		assert_eq!(two / SignedDecimal256::percent(1), SignedDecimal256::percent(20_000));
		assert_eq!(two / SignedDecimal256::percent(10), SignedDecimal256::percent(2_000));
		assert_eq!(two / SignedDecimal256::percent(100), SignedDecimal256::percent(200));
		assert_eq!(two / SignedDecimal256::percent(1000), SignedDecimal256::percent(20));
		assert_eq!(SignedDecimal256::percent(0) / two, SignedDecimal256::percent(0));
		assert_eq!(SignedDecimal256::percent(1) / two, dec("0.005"));
		assert_eq!(SignedDecimal256::percent(10) / two, SignedDecimal256::percent(5));
		assert_eq!(SignedDecimal256::percent(100) / two, SignedDecimal256::percent(50));
		assert_eq!(SignedDecimal256::percent(1000) / two, SignedDecimal256::percent(500));
		assert_eq!(two / SignedDecimal256::percent(-1), SignedDecimal256::percent(-20_000));
		assert_eq!(SignedDecimal256::percent(-10000) / two, SignedDecimal256::percent(-5000));

		// half
		assert_eq!(half / SignedDecimal256::percent(1), SignedDecimal256::percent(5_000));
		assert_eq!(half / SignedDecimal256::percent(10), SignedDecimal256::percent(500));
		assert_eq!(half / SignedDecimal256::percent(100), SignedDecimal256::percent(50));
		assert_eq!(half / SignedDecimal256::percent(1000), SignedDecimal256::percent(5));
		assert_eq!(SignedDecimal256::percent(0) / half, SignedDecimal256::percent(0));
		assert_eq!(SignedDecimal256::percent(1) / half, SignedDecimal256::percent(2));
		assert_eq!(SignedDecimal256::percent(10) / half, SignedDecimal256::percent(20));
		assert_eq!(SignedDecimal256::percent(100) / half, SignedDecimal256::percent(200));
		assert_eq!(SignedDecimal256::percent(1000) / half, SignedDecimal256::percent(2000));
	...
	fn signed_decimal_256_checked_pow() {
		for exp in 0..10 {
			assert_eq!(SignedDecimal256::one().checked_pow(exp).unwrap(), SignedDecimal256::one());
		}
		...
		assert_eq!(SignedDecimal256::zero().checked_pow(0).unwrap(), SignedDecimal256::one());
	...
	fn signed_decimal_256_to_string() {
		...
		assert_eq!(SignedDecimal256(Int256::from(1i128)).to_string(), "0.000000000000000001");
		assert_eq!(SignedDecimal256(Int256::from(10i128)).to_string(), "0.00000000000000001");
		assert_eq!(SignedDecimal256(Int256::from(100i128)).to_string(), "0.0000000000000001");
		assert_eq!(SignedDecimal256(Int256::from(1000i128)).to_string(), "0.000000000000001");
		assert_eq!(SignedDecimal256(Int256::from(10000i128)).to_string(), "0.00000000000001");
		assert_eq!(SignedDecimal256(Int256::from(100000i128)).to_string(), "0.0000000000001");
		assert_eq!(SignedDecimal256(Int256::from(1000000i128)).to_string(), "0.000000000001");
		assert_eq!(SignedDecimal256(Int256::from(10000000i128)).to_string(), "0.00000000001");
		assert_eq!(SignedDecimal256(Int256::from(100000000i128)).to_string(), "0.0000000001");
		assert_eq!(SignedDecimal256(Int256::from(1000000000i128)).to_string(), "0.000000001");
		assert_eq!(SignedDecimal256(Int256::from(10000000000i128)).to_string(), "0.00000001");
		assert_eq!(SignedDecimal256(Int256::from(100000000000i128)).to_string(), "0.0000001");
		assert_eq!(SignedDecimal256(Int256::from(10000000000000i128)).to_string(), "0.00001");
		assert_eq!(SignedDecimal256(Int256::from(100000000000000i128)).to_string(), "0.0001");
		assert_eq!(SignedDecimal256(Int256::from(1000000000000000i128)).to_string(), "0.001");
		assert_eq!(SignedDecimal256(Int256::from(10000000000000000i128)).to_string(), "0.01");
		assert_eq!(SignedDecimal256(Int256::from(100000000000000000i128)).to_string(), "0.1");
		assert_eq!(SignedDecimal256(Int256::from(-1i128)).to_string(), "-0.000000000000000001");
		assert_eq!(SignedDecimal256(Int256::from(-100000000000000i128)).to_string(), "-0.0001");
		assert_eq!(SignedDecimal256(Int256::from(-100000000000000000i128)).to_string(), "-0.1");
	}
	...
	fn signed_decimal_256_iter_sum() {
		...
		assert_eq!(items.iter().sum::<SignedDecimal256>(), SignedDecimal256(Int256::from(2i128)));
		assert_eq!(
		...
		assert_eq!(SignedDecimal256::zero(), empty.iter().sum::<SignedDecimal256>());
	}

	#[test]
	fn signed_decimal_256_serialize() {
		assert_eq!(serde_json::to_vec(&SignedDecimal256::zero()).unwrap(), br#""0""#);
		assert_eq!(serde_json::to_vec(&SignedDecimal256::one()).unwrap(), br#""1""#);
		assert_eq!(serde_json::to_vec(&SignedDecimal256::percent(8)).unwrap(), br#""0.08""#);
		assert_eq!(serde_json::to_vec(&SignedDecimal256::percent(87)).unwrap(), br#""0.87""#);
		assert_eq!(serde_json::to_vec(&SignedDecimal256::percent(876)).unwrap(), br#""8.76""#);
		assert_eq!(serde_json::to_vec(&SignedDecimal256::percent(8765)).unwrap(), br#""87.65""#);
		assert_eq!(
			serde_json::to_vec(&SignedDecimal256::percent(-87654)).unwrap(),
			br#""-876.54""#
		);
		assert_eq!(serde_json::to_vec(&SignedDecimal256::negative_one()).unwrap(), br#""-1""#);
		assert_eq!(serde_json::to_vec(&-SignedDecimal256::percent(8)).unwrap(), br#""-0.08""#);
	}
	...
	fn signed_decimal_256_checked_methods() {
		...
		assert_eq!(
			SignedDecimal256::zero().checked_sub(SignedDecimal256::percent(1)).unwrap(),
			SignedDecimal256::percent(-1)
		);
		assert!(matches!(
	...
	fn signed_decimal_256_pow_works() {
		assert_eq!(SignedDecimal256::percent(200).pow(2), SignedDecimal256::percent(400));
		assert_eq!(SignedDecimal256::percent(-200).pow(2), SignedDecimal256::percent(400));
		assert_eq!(SignedDecimal256::percent(-200).pow(3), SignedDecimal256::percent(-800));
		assert_eq!(SignedDecimal256::percent(200).pow(10), SignedDecimal256::percent(102400));
	}
	...
	fn signed_decimal_256_saturating_works() {
		...
		assert_eq!(SignedDecimal256::MAX.saturating_pow(2u32), SignedDecimal256::MAX);
		assert_eq!(SignedDecimal256::MAX.saturating_pow(3u32), SignedDecimal256::MAX);
		assert_eq!(SignedDecimal256::MIN.saturating_pow(2u32), SignedDecimal256::MAX);
		assert_eq!(SignedDecimal256::MIN.saturating_pow(3u32), SignedDecimal256::MIN);
	}

	#[test]
	fn signed_decimal_256_rounding() {
		assert_eq!(SignedDecimal256::one().floor(), SignedDecimal256::one());
		assert_eq!(SignedDecimal256::percent(150).floor(), SignedDecimal256::one());
		assert_eq!(SignedDecimal256::percent(199).floor(), SignedDecimal256::one());
		assert_eq!(SignedDecimal256::percent(200).floor(), SignedDecimal256::percent(200));
		assert_eq!(SignedDecimal256::percent(99).floor(), SignedDecimal256::zero());
		assert_eq!(SignedDecimal256(Int256::from(1i128)).floor(), SignedDecimal256::zero());
		assert_eq!(
			SignedDecimal256(Int256::from(-1i128)).floor(),
			SignedDecimal256::negative_one()
		);
		assert_eq!(SignedDecimal256::permille(-1234).floor(), SignedDecimal256::percent(-200));

		assert_eq!(SignedDecimal256::one().ceil(), SignedDecimal256::one());
		assert_eq!(SignedDecimal256::percent(150).ceil(), SignedDecimal256::percent(200));
		assert_eq!(SignedDecimal256::percent(199).ceil(), SignedDecimal256::percent(200));
		assert_eq!(SignedDecimal256::percent(99).ceil(), SignedDecimal256::one());
		assert_eq!(SignedDecimal256(Int256::from(1i128)).ceil(), SignedDecimal256::one());
		assert_eq!(SignedDecimal256(Int256::from(-1i128)).ceil(), SignedDecimal256::zero());
		assert_eq!(SignedDecimal256::permille(-1234).ceil(), SignedDecimal256::negative_one());

		assert_eq!(SignedDecimal256::one().trunc(), SignedDecimal256::one());
		assert_eq!(SignedDecimal256::percent(150).trunc(), SignedDecimal256::one());
		assert_eq!(SignedDecimal256::percent(199).trunc(), SignedDecimal256::one());
		assert_eq!(SignedDecimal256::percent(200).trunc(), SignedDecimal256::percent(200));
		assert_eq!(SignedDecimal256::percent(99).trunc(), SignedDecimal256::zero());
		assert_eq!(SignedDecimal256(Int256::from(1i128)).trunc(), SignedDecimal256::zero());
		assert_eq!(SignedDecimal256(Int256::from(-1i128)).trunc(), SignedDecimal256::zero());
		assert_eq!(SignedDecimal256::permille(-1234).trunc(), SignedDecimal256::negative_one());
	}
	...
	fn signed_decimal_256_checked_ceil() {
		...
		assert_eq!(SignedDecimal256::MAX.checked_ceil(), Err(RoundUpOverflowError));
	}

	#[test]
	fn signed_decimal_256_checked_floor() {
		assert_eq!(SignedDecimal256::percent(199).checked_floor(), Ok(SignedDecimal256::one()));
		assert_eq!(
			SignedDecimal256::percent(-199).checked_floor(),
			Ok(SignedDecimal256::percent(-200))
		);
		assert_eq!(SignedDecimal256::MIN.checked_floor(), Err(RoundDownOverflowError));
		assert_eq!(
	...
	fn signed_decimal_256_neg_works() {
		assert_eq!(-SignedDecimal256::percent(50), SignedDecimal256::percent(-50));
	...
	fn signed_decimal_256_can_be_serialized_and_deserialized() {
		...
		assert_eq!(
			...
			serde_json::from_str::<SignedDecimal256>("123").err().unwrap().to_string()
		);
