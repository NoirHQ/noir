...
pub trait Erc20Metadata<I: 'static = ()> {
	...
	Runtime: Erc20Metadata<Instance>,
{
	...
	fn balance_of(handle: &mut impl PrecompileHandle, owner: Address) -> EvmResult<U256> {
		...
		// Blake2_128(16) + AccountId(32) + AccountInfo ((4 * 4) + AccountData(16 * 4))
	...
	fn allowance(
		...
		// (2 * (Blake2_128(16) + AccountId(32)) + Balanceof(16)
