...
use crate::svm::nonce_info::{NonceInfo, NoncePartial};
use solana_sdk::{
...
pub enum RollbackAccounts {
	...
	SameNonceAndFeePayer { nonce: NoncePartial },
	SeparateNonceAndFeePayer { nonce: NoncePartial, fee_payer_account: AccountSharedData },
}
