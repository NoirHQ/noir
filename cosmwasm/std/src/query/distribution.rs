...
use crate::{prelude::*, Addr, Decimal256};
...
pub enum DistributionQuery {
	...
	DelegationRewards { delegator_address: String, validator_address: String },
...
pub struct DecCoin {
	...
	///
	/// Some chains have choosen atto (10^-18) for their token's base denomination. If we used
	/// `Decimal` here, we could only store 340282366920938463463.374607431768211455atoken which
	/// is 340.28 TOKEN.
