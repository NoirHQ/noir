...
const AFTER_HELP_EXAMPLE: &str = color_print::cstr!(
   ...
   <bold>ziggurat build-spec --disable-default-bootnode > ziggurat.plain.json</>
           Export a chainspec for a local testnet in json format.
   <bold>ziggurat --chain ziggurat.plain.json --tmp -- --chain paseo-local</>
           Launch a full node with chain specification loaded from ziggurat.plain.json.
   <bold>ziggurat</>
           Launch a full node with default parachain <italic>local-testnet</> and relay chain <italic>paseo-local</>.
   <bold>ziggurat --collator</>
...
pub struct Cli {
	...
	#[command(flatten)]
	pub eth_config: crate::eth::Configuration,
